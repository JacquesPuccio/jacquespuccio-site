              ...
              <div className="grid gap-12 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
                <div>
                  ...
                  <p className="mt-6 max-w-2xl text-lg leading-8 text-white/60 font-inter">
                    I’m Jacques — working across SaaS, lead generation, property
                    services, and scalable workflows. I connect business,
            ...
            <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr]">
              ...
              <div className="space-y-6 text-white/75 leading-8">
                <p>
                  ...
                  with integrations, channel managers, customer-facing systems,
                  and revenue-impacting workflows.
                </p>
                <p>
                  Today, I’m applying that same thinking to service businesses:
                  building lead generation systems, improving execution, and
                  helping companies grow with more structure and less chaos.
                </p>
                <p>
